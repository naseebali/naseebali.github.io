...
const clientReviews = [
  {
    clientAvatar: "/assets/Images/naseeb-project1.jpg",
    clientName: "Passport Paws",
    Technologies: ["HTML5", "CSS3", "Nextjs", "Styled Components", "Ant Design"],
    id: "passportPaws",
  },
  {
    clientAvatar: "/assets/Images/naseeb-project2.jpg",
    clientName: "Nithias Accadmy",
    Technologies: ["HTML5", "CSS3", "Nextjs", "styled Components", "Ant Design"],
    id: "nithiasAccadmy",
  },
  {
    clientAvatar: "/assets/Images/naseeb-project3.jpg",
    clientName: "Lazard Plumbing",
    Technologies: ["HTML5", "CSS3", "Bootstrap", "Squarespace"],
    id: "lazardPlumbing",
  },
  {
    Technologies: ["HTML5", "CSS3", "Bootstrap"],
    clientAvatar: "/assets/Images/naseeb-project4.jpg",
    clientName: "ANIT Services",
    id: "anitService",
  },
  {
    clientAvatar: "/assets/Images/naseeb-project5.jpg",
    clientName: "Ebay Label Generator Tool",
    Technologies: ["HTML5", "CSS3", "Reactjs"],
    id: "ebayTool",
  },
  {
    clientAvatar: "/assets/Images/naseeb-project6.jpg",
    clientName: "Carstreet",
    Technologies: ["HTML5", "CSS3", "Nextjs", "styled component", "Ant Design"],
    id: "carstreet",
  },
];
        ...
        >
          {clientReviews.map((key, index) => (
            <CarousalContainer key={index}>
              ...
              <HoverContainer className="hover-effect">
                <H3>{key.clientName}</H3>
                <TechnologContainer>
                  {key.Technologies.map((key, index) => (
...
`;
const CarousalContainer = ({ children }) => {

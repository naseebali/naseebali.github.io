    ...
    <Section id="work">
      ...
      <div>
        <Carousel
          ...
          responsive={responsive}
        >
          <CarousalContainer style={{ background: "red", height: "200px" }}>
            Item 1
          </CarousalContainer>
          <CarousalContainer style={{ background: "blue", height: "200px" }}>
            Item 2
          </CarousalContainer>
          <CarousalContainer style={{ background: "yellow", height: "200px" }}>
            Item 3
          </CarousalContainer>
          <CarousalContainer style={{ background: "pink", height: "200px" }}>
            Item 4
          </CarousalContainer>
        </Carousel>
      </div>
